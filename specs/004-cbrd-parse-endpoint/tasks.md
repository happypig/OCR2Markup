...
**2026-08-02: Phase 8 code tasks (T080–T082, T081a) and Phase 9 (T090–T093a) complete. `mvn test`: 356 tests, 0 failures**
...
"CBRD Link timeout (ms)" (display-only, FR-023/US5), and the 0.5.0 release
notes fold in both changes (version NOT bumped).
